...
const Submissions = ({ questionId, user }: { questionId: string; user: User | null }) => {
  ...
  if (!user)
    return (
      <div className="text-center space-y-5 flex flex-col self-center mx-auto w-full">
        ...
        <TypographyH4>Sign in to submit code</TypographyH4>
      </div>
    )
  ...
  if (!savedFiles || savedFiles.length === 0) {
    return (
      <div className="text-center space-y-5 flex flex-col self-center mx-auto w-full">
        ...
        <TypographyH4>No Submissions</TypographyH4>
      </div>
    )
  }
